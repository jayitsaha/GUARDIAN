...
const SignUpScreen = ({navigation}) => {
  const [selectedValue, setSelectedValue] = React.useState('Field Rep');
...
//    return returnValue;
  ...
  return (
    <ScrollView style={styles.container}>
      <StatusBar backgroundColor="#3B228A" barStyle="light-content" />
      ...
      <ModalPopup visible={visible}>
        ...
        <View style={styles.containerButton}>
          <View style={{marginTop: 19}}>
            <BouncyCheckbox
              isChecked={selectedValue == 'Field Rep'}
              textColor="blue"
              borderColor="black"
              fillColor="#40c164"
              key={Math.random()}
              onPress={checked => changeRole('Field Rep')}></BouncyCheckbox>
          </View>
          <Text style={styles.text_footer}>Field Rep</Text>
        ...
        <View style={styles.containerButton}>
                  <View style={{marginTop: 19}}>
                    <BouncyCheckbox
                      ...
                      fillColor="#40c164"
                      key={Math.random()}
                      onPress={checked => changeRole('Supplier')}></BouncyCheckbox>
                  </View>
                  <Text style={styles.text_footer}>Supplier</Text>
      ...
      {(selectedValue === 'Field Rep' || selectedValue === 'Supplier') && (
